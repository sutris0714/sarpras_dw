		...
		<table class="table table-sm">
			<tr>
				...
				<th align="left" valign="middle">
					...
					<small class="sub-title">SMP Katolik Santo Paulus</small>
				</th>
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Phone: <span class="sub-title">+6281316698414</span></div>
						<div>Email: <span class="sub-title">ops.saintpaul@gmail.com</span></div>
		...
		<table class="table table-sm">
			<tr>
				...
				<td align="left" valign="middle">
					SMP KATOLIK SANTO PAULUS<br>
Jl. Danau Agung 13 Blok E, Sunter Agung, Tanjung Priok, Jak-Ut
				</td>
