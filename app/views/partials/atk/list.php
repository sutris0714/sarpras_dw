    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("atk/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New Atk 
                    </a>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('atk'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('atk'); ?>">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-nama_barang">
                                                    <span  data-source='<?php print_link('api/json/atk_nama_barang_option_list'); ?>' 
                                                ...
                                                <td class="td-merk">
                                                    <span  data-source='<?php print_link('api/json/atk_merk_option_list'); ?>' 
                                                ...
                                                <td class="td-spesifikasi">
                                                    <span  data-source='<?php 
                                                        ...
                                                        print_link('api/json/atk_spesifikasi_option_list/'.$dependent_field); 
                                                        ?>' 
                                                ...
                                                <td class="td-penempatan">
                                                    <span  data-source='<?php 
                                                        ...
                                                        print_link('api/json/atk_penempatan_option_list/'.$dependent_field); 
                                                        ?>' 
