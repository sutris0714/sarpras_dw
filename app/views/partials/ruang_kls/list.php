...
$can_add = ACL::is_allowed("ruang_kls/add");
$can_edit = ACL::is_allowed("ruang_kls/edit");
$can_view = ACL::is_allowed("ruang_kls/view");
$can_delete = ACL::is_allowed("ruang_kls/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Ruang Kls</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("ruang_kls/add") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('ruang_kls'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('ruang_kls'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-id_rkel"> Id Rkel</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            $rec_id = (!empty($data['id_rkel']) ? urlencode($data['id_rkel']) : null);
                                            $counter++;
                                            ?>
                                            <tr>
                                                <?php if($can_delete){ ?>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['id_rkel'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <?php } ?>
                                                    ...
                                                    <td class="td-jenis_prasarana">
                                                        <span <?php if($can_edit){ ?> data-source='<?php echo json_encode_quote(Menu :: $jenis_prasarana2); ?>' 
                                                            data-value="<?php echo $data['jenis_prasarana']; ?>" 
                                                            data-pk="<?php echo $data['id_rkel'] ?>" 
                                                            data-url="<?php print_link("ruang_kls/editfield/" . urlencode($data['id_kepgr'])); ?>" 
                                                    ...
                                                    <td class="td-nama_ruang">
                                                        <span <?php if($can_edit){ ?> data-source='<?php echo json_encode_quote(Menu :: $jenis_prasarana2); ?>' 
                                                            data-value="<?php echo $data['nama_ruang']; ?>" 
                                                            data-pk="<?php echo $data['id_rkel'] ?>" 
                                                            data-url="<?php print_link("ruang_kls/editfield/" . urlencode($data['id_kepgr'])); ?>" 
                                                    ...
                                                    <td class="td-id_rkel">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['id_rkel']; ?>" 
                                                            data-pk="<?php echo $data['id_rkel'] ?>" 
                                                            data-url="<?php print_link("ruang_kls/editfield/" . urlencode($data['id_kepgr'])); ?>" 
                                                            data-name="id_rkel" 
                                                            data-title="Enter Id Rkel" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['id_rkel']; ?> 
                                                        </span>
                                                    </td>
                                                    <th class="td-btn">
                                                        <?php if($can_view){ ?>
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("ruang_kls/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_edit){ ?>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("ruang_kls/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_delete){ ?>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("ruang_kls/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <?php if($can_delete){ ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("ruang_kls/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
