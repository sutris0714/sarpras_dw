...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">ATK</h4>
                </div>
                <div class="col-sm-3 ">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("atkb/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New ATK 
                    </a>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('atkb'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('atkb'); ?>">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-nama_barang">
                                                    <span  data-source='<?php print_link('api/json/atkb_nama_barang_option_list'); ?>' 
                                                ...
                                                <td class="td-merk">
                                                    <span  data-source='<?php print_link('api/json/atkb_merk_option_list'); ?>' 
                                                ...
                                                <td class="td-spesifikasi">
                                                    <span  data-source='<?php print_link('api/json/atkb_spesifikasi_option_list'); ?>' 
                                                ...
                                                <td class="td-jumlah_barang">
                                                    <span  data-source='<?php print_link('api/json/atkb_jumlah_barang_option_list'); ?>' 
                                                ...
                                                <td class="td-harga_satuan">
                                                    <span  data-source='<?php print_link('api/json/atkb_harga_satuan_option_list'); ?>' 
                                                ...
                                                <td class="td-penempatan">
                                                    <span  data-source='<?php print_link('api/json/atkb_penempatan_option_list'); ?>' 
