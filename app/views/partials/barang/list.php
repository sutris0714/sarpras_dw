...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">KARTU INVENTARIS BARANG</h4>
                    <h5 >SMP KATOLIK SANTO PAULUS</h5>
                    <h6 >Jl. Danau Agung 13 Blok E, Sunter Agung, Tanjung Priok, Jak-Ut</h6>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-jumlah_barang"> Jmlh Barang</th>
                                                <th  class="td-sumber"> Sumber</th>
                                                <th  class="td-tgl_beli"> Tgl Beli</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            $rec_id = (!empty($data['id_brng']) ? urlencode($data['id_brng']) : null);
                                            $counter++;
                                            ?>
                                            <tr>
                                                <?php if($can_delete){ ?>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['id_brng'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <?php } ?>
                                                    ...
                                                    <td class="td-nama_barang">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['nama_barang']; ?>" 
                                                            data-pk="<?php echo $data['id_brng'] ?>" 
                                                            data-url="<?php print_link("barang/editfield/" . urlencode($data['id_brng'])); ?>" 
