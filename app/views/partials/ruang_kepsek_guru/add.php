...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Ruang Kepsek Guru</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="ruang_kepsek_guru-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("ruang_kepsek_guru/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="jenis_prasarana">Jenis Prasarana <span class="text-danger">*</span></label>
                                    <div id="ctrl-jenis_prasarana-holder" class=""> 
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-kode_ruang-holder" class=""> 
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-nama_ruang-holder" class=""> 
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-registrasi_ruang-holder" class=""> 
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-Lantai_ke-holder" class=""> 
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div id="ctrl-panjang-holder" class=""> 
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div id="ctrl-lebar-holder" class=""> 
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div id="ctrl-luas_plester-holder" class=""> 
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div id="ctrl-luas_plafon-holder" class=""> 
                                                                            ...
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div id="ctrl-luas_dinding-holder" class=""> 
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div id="ctrl-luas_daun_jendela-holder" class=""> 
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div id="ctrl-luas_daun_pintu-holder" class=""> 
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div id="ctrl-panjang_kusen-holder" class=""> 
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div id="ctrl-luas_tutup_lantai-holder" class=""> 
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div id="ctrl-luas_instalasi_listrik-holder" class=""> 
                                                                                                    ...
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div id="ctrl-jml_instalasi_listrik-holder" class=""> 
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div id="ctrl-panjang_instalasi_air-holder" class=""> 
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div id="ctrl-jml_instalasi_air-holder" class=""> 
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div id="ctrl-panjang_drainase-holder" class=""> 
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        ...
                                                                                                                        <div id="ctrl-luas_finish_struktur-holder" class=""> 
                                                                                                                        ...
                                                                                                                        <div class="form-group ">
                                                                                                                            ...
                                                                                                                            <div id="ctrl-luas_finish_plafon-holder" class=""> 
                                                                                                                            ...
                                                                                                                            <div class="form-group ">
                                                                                                                                ...
                                                                                                                                <div id="ctrl-luas_finish_dinding-holder" class=""> 
