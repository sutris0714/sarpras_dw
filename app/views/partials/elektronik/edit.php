...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Elektronik</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("elektronik/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-yg_mengajukan" data-load-select-options="tipe_barang" name="yg_mengajukan"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $yg_mengajukan_options = $comp_model -> elektronik_yg_mengajukan_option_list();
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-tipe_barang" data-load-path="<?php print_link('api/json/elektronik_tipe_barang_option_list') ?>" data-load-select-options="nama_barang" name="tipe_barang"  placeholder="Perhatikan yg akan dipilih"    class="custom-select" >
                                                    <?php
                                                    $rec = $data['tipe_barang'];
                                                    $tipe_barang_options = $comp_model -> elektronik_tipe_barang_option_list($data['yg_mengajukan']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-nama_barang" data-load-path="<?php print_link('api/json/elektronik_nama_barang_option_list') ?>" data-load-select-options="merk" name="nama_barang"  placeholder="Pilih setelah input pengajuan.."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['nama_barang'];
                                                    $nama_barang_options = $comp_model -> elektronik_nama_barang_option_list($data['tipe_barang']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-merk" data-load-path="<?php print_link('api/json/elektronik_merk_option_list') ?>" data-load-select-options="spesifikasi" name="merk"  placeholder="Pilih setelah input pengajuan.."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['merk'];
                                                    $merk_options = $comp_model -> elektronik_merk_option_list($data['nama_barang']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-spesifikasi" data-load-path="<?php print_link('api/json/elektronik_spesifikasi_option_list') ?>" data-load-select-options="jumlah_barang" name="spesifikasi"  placeholder="Pilih setelah input pengajuan.."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['spesifikasi'];
                                                    $spesifikasi_options = $comp_model -> elektronik_spesifikasi_option_list($data['merk']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-jumlah_barang" data-load-path="<?php print_link('api/json/elektronik_jumlah_barang_option_list') ?>" data-load-select-options="harga_satuan" name="jumlah_barang"  placeholder="Pilih setelah input pengajuan.."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['jumlah_barang'];
                                                    $jumlah_barang_options = $comp_model -> elektronik_jumlah_barang_option_list($data['spesifikasi']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-harga_satuan" data-load-path="<?php print_link('api/json/elektronik_harga_satuan_option_list') ?>" data-load-select-options="penempatan" name="harga_satuan"  placeholder="Pilih setelah input pengajuan.."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['harga_satuan'];
                                                    $harga_satuan_options = $comp_model -> elektronik_harga_satuan_option_list($data['jumlah_barang']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-penempatan" data-load-path="<?php print_link('api/json/elektronik_penempatan_option_list') ?>" name="penempatan"  placeholder="Pilih setelah input pengajuan.."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['penempatan'];
                                                    $penempatan_options = $comp_model -> elektronik_penempatan_option_list($data['harga_satuan']);
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-keterangan" name="keterangan"  placeholder="Pilih Saja ya? ..."    class="custom-select" >
                                                    <option value="">Pilih Saja ya? ...</option>
                                                    <?php
