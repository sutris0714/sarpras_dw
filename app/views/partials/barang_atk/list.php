...
$can_add = ACL::is_allowed("barang_atk/add");
$can_edit = ACL::is_allowed("barang_atk/edit");
$can_view = ACL::is_allowed("barang_atk/view");
$can_delete = ACL::is_allowed("barang_atk/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Barang Atk</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("barang_atk/add") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('barang_atk'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('barang_atk'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="barang_atk-list-records">
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            $rec_id = (!empty($data['id_batk']) ? urlencode($data['id_batk']) : null);
                                            $counter++;
                                            ?>
                                            <tr>
                                                <?php if($can_delete){ ?>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['id_batk'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <?php } ?>
                                                    ...
                                                    <td class="td-yg_mengajukan">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/barang_atk_yg_mengajukan_option_list'); ?>' 
                                                            data-value="<?php echo $data['yg_mengajukan']; ?>" 
                                                            data-pk="<?php echo $data['id_batk'] ?>" 
                                                            data-url="<?php print_link("barang_atk/editfield/" . urlencode($data['id_batk'])); ?>" 
                                                    ...
                                                    <td class="td-tipe_barang">
                                                        <span <?php if($can_edit){ ?> data-source='<?php 
                                                            ...
                                                            print_link('api/json/barang_atk_tipe_barang_option_list/'.$dependent_field); 
                                                            ?>' 
                                                    ...
                                                    <td class="td-nama_barang">
                                                        <span <?php if($can_edit){ ?> data-source='<?php 
                                                            ...
                                                            print_link('api/json/barang_atk_nama_barang_option_list/'.$dependent_field); 
                                                            ?>' 
                                                    ...
                                                    <td class="td-merk">
                                                        <span <?php if($can_edit){ ?> data-source='<?php 
                                                            ...
                                                            print_link('api/json/barang_atk_merk_option_list/'.$dependent_field); 
                                                            ?>' 
                                                    ...
                                                    <td class="td-spesifikasi">
                                                        <span <?php if($can_edit){ ?> data-source='<?php 
                                                            ...
                                                            print_link('api/json/barang_atk_spesifikasi_option_list/'.$dependent_field); 
                                                            ?>' 
                                                    ...
                                                    <td class="td-jumlah_barang">
                                                        <span <?php if($can_edit){ ?> data-source='<?php 
                                                            ...
                                                            print_link('api/json/barang_atk_jumlah_barang_option_list/'.$dependent_field); 
                                                            ?>' 
                                                    ...
                                                    <td class="td-harga_satuan">
                                                        <span <?php if($can_edit){ ?> data-source='<?php 
                                                            ...
                                                            print_link('api/json/barang_atk_harga_satuan_option_list/'.$dependent_field); 
                                                            ?>' 
                                                    ...
                                                    <td class="td-penempatan">
                                                        <span <?php if($can_edit){ ?> data-source='<?php 
                                                            ...
                                                            print_link('api/json/barang_atk_penempatan_option_list/'.$dependent_field); 
                                                            ?>' 
                                                    ...
                                                    <th class="td-btn">
                                                        <?php if($can_view){ ?>
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("barang_atk/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_edit){ ?>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("barang_atk/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>
                                                        <?php } ?>
                                                        <?php if($can_delete){ ?>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("barang_atk/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <?php if($can_delete){ ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("barang_atk/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
