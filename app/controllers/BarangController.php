...
class BarangController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("barang.id_brng", ORDER_TYPE);
		}
		if($fieldname){
		...
		$page_title = $this->view->page_title = "KARTU INVENTARIS BARANG";
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("barang.id_brng", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_barang","merk","spesifikasi","harga_satuan","jumlah_barang","sumber","tgl_beli","penempatan","foto","barcode");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_brng","nama_barang","merk","spesifikasi","harga_satuan","jumlah_barang","sumber","tgl_beli","penempatan","foto","barcode");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama_barang' => 'required',
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("barang.id_brng", $rec_id);;
	...
	function delete($rec_id = null){
		...
		$db->where("barang.id_brng", $arr_rec_id, "in");
